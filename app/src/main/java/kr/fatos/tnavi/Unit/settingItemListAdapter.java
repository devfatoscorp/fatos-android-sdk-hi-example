    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        switch(settingItemList.get(position).m_nType)
        {
            case settingItemDetailList.SETTING_TYPE_TEXT:
            {
                ...
                holder.txt_settingTitleName.setTextColor(
                        m_Context.getResources().getColor(R.color.black));
                holder.txt_settingDataName.setTextColor(
                        m_Context.getResources().getColor(R.color.black));
            ...
            case settingItemDetailList.SETTING_TYPE_ROUTELINE:
            {
                ...
                holder.txt_settingTitleName.setTextColor(
                        m_Context.getResources().getColor(R.color.black));
                holder.btn_RouteLineColor.setBackgroundColor(
        ...
        {
            holder.txt_settingTitleName.setTextColor(
                    m_Context.getResources().getColor(R.color.lightGray));
            holder.txt_settingDataName.setTextColor(
                    m_Context.getResources().getColor(R.color.lightGray));
        }
