...
public class SearchSettingActivity extends FMBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new FragmentPagerItemAdapter(
                ...
                .add(getString(R.string.string_wegeneral), Setting_SearchCategoryFragment.class)
                .add(getString(R.string.string_nostrasetting_country), CountrySelectFragment.class)
                .create());
