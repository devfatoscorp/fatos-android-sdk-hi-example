...
*/
        ...
        static int[] SETTING_NAVI_MENU_NAME_ROUTECOLOR = new int[]{Color.argb(255,255,0,0), Color.argb(255,0,255,0) , Color.argb(255,0,0,255),
                Color.argb(255,255,0,255), Color.argb(255,255,255,0), Color.argb(255,117,157,249),
                Color.argb(255,127,127,127), Color.argb(255,127,63,0), Color.argb(255,0,63,127)
        };
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            adapter = new FragmentPagerItemAdapter(
                    ...
                    .add(getString(R.string.string_wegeneral), NostraSettingFragment.class)
                    .add(getString(R.string.string_wenavigation), NaviSettingFragment.class)
                    .create());
